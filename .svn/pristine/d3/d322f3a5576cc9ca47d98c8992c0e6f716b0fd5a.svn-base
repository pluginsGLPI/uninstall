...
xgettext *.php */*.php --copyright-holder='Uninstall Development Team' --package-name='GLPI - Uninstall plugin' --package-version='2.2.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
